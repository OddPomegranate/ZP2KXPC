...
public class Smoke
{
	...
	public static void Draw(Particle p, SpriteBatch sprite)
	{
		...
		sprite.Draw(Game1.spritesTex, Scroll.GetLoc(p.loc), (Rectangle?)new Rectangle(64, 0, 64, 64), new Color(new Vector4(p.frame * 0.4f, p.frame * 0.4f, p.frame * 0.4f, p.frame * 0.4f)), p.angle, new Vector2(32f, 32f), p.size * Scroll.zoom + (1f - p.frame), (SpriteEffects)0, 1f);
	}
}
