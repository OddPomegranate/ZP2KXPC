...
public class MiniBullet
{
	...
	public static void Update(Particle p, GameMap map, Character[] c, float fTime)
	{
		...
		Vector2 vector = p.loc + p.traj * Rand.GetRandomFloat(0f, 0.03f);
		int num = (int)(vector.X / 64f);
		int num2 = (int)(vector.Y / 32f);
	...
	public static void Draw(Particle p, SpriteBatch sprite)
	{
		...
		sprite.Draw(Game1.spritesTex, Scroll.GetLoc(p.loc), (Rectangle?)new Rectangle(128, 0, 128, 16), new Color(new Vector4(0.5f, 0.4f, 0.2f, 0.5f)), p.angle, new Vector2(64f, 8f), Scroll.zoom * 0.2f, (SpriteEffects)0, 1f);
	}
}
